...
const MonthlyPlans = () => {
  return (
    <div>
      <article className="flex justify-between gap-5 px-12">
        <div className="w-[30%]">
          <h2>Choose the best plan for your pocket.</h2>
        </div>
        <div className="border-r-4 border-b-4 border border-black hover:border-LightBlue bg-white  subscription w-[30%] text-[14px] p-3 ">
          <div>
